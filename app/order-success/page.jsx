...
const OrderSuccessPage = () => {
    ...
    return (
        <div className="bg-[#FAF9F6] min-h-screen pt-28 pb-32 font-inter flex items-center justify-center">
            <div className="container mx-auto px-6 max-w-2xl text-center space-y-8">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-neutral-400 text-sm md:text-base font-bold uppercase tracking-widest leading-relaxed">
